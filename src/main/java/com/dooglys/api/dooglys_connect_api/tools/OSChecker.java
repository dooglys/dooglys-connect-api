package com.dooglys.api.dooglys_connect_api.tools;

import com.dooglys.api.dooglys_connect_api.settings.types.OperatingSystem;
import com.dooglys.api.dooglys_connect_api.settings.types.ProcessorArchitecture;
